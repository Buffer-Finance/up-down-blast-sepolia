export const ConfigMarket = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint32", name: "_iv", type: "uint32" },
    ],
    name: "UpdateIV",
    type: "event",
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "sf", type: "uint256" },
    ],
    name: "UpdateSf",
    type: "event",
  },
  ...
  },
  {
    ...
    name: "pool",
    outputs: [
      { internalType: "contract BufferBinaryPool", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint128", name: "_strikeStepSize", type: "uint128" },
    ],
