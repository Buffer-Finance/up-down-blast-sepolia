export const Market = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "isAbove", type: "bool" },
    ],
    name: "Exercise",
    type: "event",
  },
  ...
  {
    inputs: [
      { internalType: "address", name: "addressToApprove", type: "address" },
    ],
    name: "approveAddress",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "config",
    outputs: [
      { internalType: "contract IOptionsConfig", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "revisedContracts", type: "uint256" },
  ...
  },
  {
    inputs: [
      { internalType: "bytes32", name: "marketId", type: "bytes32" },
      { internalType: "uint256", name: "_baseFeePerContract", type: "uint256" },
      { internalType: "bool", name: "isAbove", type: "bool" },
    ],
  ...
  {
    inputs: [
      { internalType: "contract ERC20", name: "_tokenX", type: "address" },
      {
  ...
  },
  {
    ...
    name: "pool",
    outputs: [
      { internalType: "contract ILiquidityPool", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    name: "referral",
    outputs: [
      { internalType: "contract IReferralStorage", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
